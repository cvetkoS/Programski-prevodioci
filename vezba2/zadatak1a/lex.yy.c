...
static const flex_int16_t yy_base[25] =
    {   0,
        0,    7,   23,   31,    0,    0,   12,   18,    9,    0,
       16,   15,    0,    8,   13,    0,    7,    0,   31,   31,
       25,    5,    2,   27
    } ;

static const flex_int16_t yy_def[25] =
    {   0,
       21,   21,   20,   20,   22,   23,   22,   22,   20,    8,
       23,   20,   24,   20,   20,   24,   20,   20,   20,    0,
       20,   20,   20,   20
    } ;

static const flex_int16_t yy_nxt[45] =
    {   0,
       20,    5,    6,   11,    7,    8,   10,    9,    5,    6,
       19,    7,    8,   18,    9,   12,   15,   17,   12,   15,
       14,   12,   20,   20,   13,    4,    4,    4,   16,   16,
...
static const flex_int16_t yy_chk[45] =
    {   0,
        0,    1,    1,   23,    1,    1,   22,    1,    2,    2,
       18,    2,    2,   17,    2,    7,   15,   14,   12,   11,
        9,    8,    3,    0,    7,   21,   21,   21,   24,   24,
...
int main()
{
    ...
    printf("\nNumber of positive real numbers: %d",realnopo);
    printf("\nNumber of negative real numbers: %d",realnone);
