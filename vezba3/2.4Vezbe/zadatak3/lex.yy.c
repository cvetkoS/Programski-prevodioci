...
static const flex_int16_t yy_base[26] =
    {   0,
       12,   11,   13,   16,    0,    0,    0,    0,    0,    0,
        0,    0,    0,   16,   16,    0,    9,    9,    7,    6,
        6,    4,    3,    2,    1
    } ;
...
static const flex_int16_t yy_def[26] =
    {   0,
       ...
       23,   24,   25,   15,    0,   15,   15,   15,   15,   15,
       15,   15,   15,   15,   15
    } ;

static const flex_int16_t yy_nxt[20] =
    {   0,
        4,    4,    4,   14,   13,   12,   11,   10,    9,    8,
        7,    6,   15,    5,    5,    3,   15,   15,   15
    } ;

static const flex_int16_t yy_chk[20] =
    {   0,
       16,   16,   16,   25,   24,   23,   22,   21,   20,   19,
       18,   17,    3,    2,    1,   15,   15,   15,   15
    } ;
...
YY_RULE_SETUP
#line 11 "zadatak3.l"
{ printf("%s %d, %d.", months[atoi(yytext)], atoi(yytext+3), atoi(yytext+6));	}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 12 "zadatak3.l"
